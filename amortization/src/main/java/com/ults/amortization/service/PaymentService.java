...
public class PaymentService {
    ...
    /**
     * Emulates PMT(interest_rate, number_payments, PV, FV, Type) function, which
     * calculates
    ...
    /**
     * Emulates FV(interest_rate, number_payments, payment, PV, Type) function,
     * which calculates
    ...
    /**
     * Emulates IPMT(interest_rate, period, number_payments, PV, FV, Type) function,
     * which calculates
     * the portion of the payment at a given period that is the interest on previous
     * balance.
     *
     * @param r    periodic interest rate represented as a decimal.
    ...
    /**
     * Emulates PPMT(interest_rate, period, number_payments, PV, FV, Type) function,
